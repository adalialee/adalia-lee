...
function SoftwareDevelopment() {
    ...
    return (
        <div className="section">
            ...
            <p className="p-intro">
                I strive to design, develop, and implement meaningful solutions for people to use. Software development gives me the tools to execute my ideas, and I leverage my background in UI/UX design and user research to build impactful products.
            </p>
